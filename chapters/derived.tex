...
\begin{document}
    ...
    \section{Polydules}
        ...
        \subsection{A Tensor and Hom on $\tt{Mod}_\infty^A$}
            ...
            \begin{proof}
                Uuuuuuugh... :(\todo{Legg inn i det minste bijeksjonen}
            \end{proof}
    ...
    \section{The Derived Category $D_\infty A$}
        ...
        \subsection{The Derived Category of Strictly Unital SHA-Algebras}
            ...
            \begin{proof}
                ...
                \begin{center}
                    \begin{tikzcd} 
                        D_\infty^{A'} \ar[tail]{r} \ar[]{d}[]{\mathbb{L}f^*} & D_\infty A'^+ \ar[]{r} \ar[]{d}[]{\mathbb{L}(f^+)^*} & D_\infty \mathbb{K} \ar[]{d}[]{\simeq} \\
                ...
                \begin{center}
                    \begin{tikzcd}
                        DU(A'^+) \ar[]{r}[]{\simeq} \ar[]{d}[]{\mathbb{L}U((f^+)^*)}[left]{\simeq} & D_\infty A'^+ \ar[]{d}[]{\mathbb{L}(f^+)^*} \\
            ...
            \begin{proof}[Proof of $D_\infty A \simeq \langle A \rangle$]
                ...
                \begin{center}
                    \begin{tikzcd}
                        M \mathbb{L}\otimes_{A^+}^\infty A \ar[]{r} & M \ar[]{r} & M \mathbb{L}\otimes_{A^+}^\infty \mathbb{K} \ar[]{r} & (M \mathbb{L}\otimes_{A^+}^\infty A)[1]
                    \end{tikzcd}
                \end{center}
                the objects $M \mathbb{L}\otimes_{A^+}^\infty A \in \langle A \rangle$ and $M \mathbb{L}\otimes_{A^+}^\infty \mathbb{K}$ are $\langle A \rangle$-local. An object of $M \in D_\infty A^+$ is said to be $\langle A \rangle$-local if for any $L \in \langle A \rangle$
                \begin{align*}
                    D_\infty A^+(L, M) = 0 \tt{.}
                \end{align*}

                We start by observing that $M \otimes_{A^+} A = M \otimes BA^+ \otimes A$, so $M \mathbb{L}\otimes_{A^+}^\infty A$ is in fact contained in $\langle A \rangle$.

                To see that $M \mathbb{L}\otimes_{A^+} \mathbb{K}$ is $\langle A \rangle$-local, we start by considering the following triangle
                \begin{center}
                    \begin{tikzcd}
                        A \mathbb{L}\otimes_{A^+}^\infty \mathbb{K} \ar[]{r} & A^+ \mathbb{L}\otimes_{A^+}^\infty \mathbb{K} \ar[]{r} & \mathbb{K} \mathbb{L}\otimes_{A^+}^\infty \mathbb{K} \ar[]{r} & (A \mathbb{L}\otimes_{A^+}^\infty \mathbb{K})[1]
                    \end{tikzcd}
                \end{center}
                ...
                \begin{center}
                    \begin{tikzcd}
                        L \ar[]{r}[]{f} \ar[]{d} & M \mathbb{L}\otimes_{A^+}^\infty \ar[]{d}[]{\simeq} \\
                        L \mathbb{L}\otimes_{A+}^\infty \ar[]{r} & M \mathbb{L}\otimes_{A^+}^\infty \mathbb{K} \mathbb{L}\otimes_{A^+}^\infty
                    \end{tikzcd}
                \end{center}

                As $L \mathbb{L}\otimes_{A^+}^\infty \mathbb{K} \simeq 0$, the morphism $f$ factors $0$. Thus $f = 0$.
            \end{proof}
            ...
            \begin{proof}[Proof of $\tt{suMod}_\infty^A{[\tt{Qis}^{-1}]} \simeq \tt{Ho}(\tt{suMod}_\infty^A)$]
               Assume first that $A$ is a differential graded associative algebra. We have the following chain of faithfull inclusions
                ...
                \end{center}
                 ...
                 \end{align*}
                 then we would be done. This is because $\mathbb{L}p^* : D_\infty A' \rightarrow D_\infty A$ induces an equivalence by Theorem~\ref{thm: derived-is-well-defined}. Thus we may consider the following commutative diagram
                 \begin{center}
                    \begin{tikzcd}
                ...
                \end{align*}\todo{Se over dette igjen, her kan det være noe sirkelargument.}
            \end{proof}
\end{document}
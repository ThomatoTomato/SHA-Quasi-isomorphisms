...
\begin{document}
    ...
    \section{Twisting Morphisms}
        ...
        \subsection{Triangulation of Homotopy Categories}
            ...
            \begin{lemma}[Devissage]
                Let $F: \mathcal{T} \rightarrow \mathcal{U}$ be a triangulated functor between triangulated categories. Suppose $S\subseteq \mathcal{T}$ is a class of objects closed under shift, and denote $\langle S \rangle$ for the smallest thick triangulated subcategory (closed under well-ordered homotopy colimits). If $F|_S$ is fully faithful, then $F|_{\widehat{S}}$ is fully faithful as well.
            \end{lemma}
    ...
    \section{Polydules}
        ...
        \subsection{Bipolydules}
            ...
            \begin{definition}[Strictly Unitary $A$-$A'$-Bipolydule]
        ...
        \subsection{Homologically Unital SHA-Algebras and Polydules}
            ...
            \begin{definition}[Homological unitary $A_\infty$-algebra]
        ...
        \subsection{H-Unitary SHA-Algebras and Polydules}
            ...
            \begin{proof}
                ...
                \begin{center}
                    \begin{tikzcd}
                        0 \ar[]{r}[]{} & M \otimes_\tau BA \otimes_\tau A^+ \ar[]{r}[]{} & M \otimes_\tau BA \otimes_\tau \mathbb{K} \ar[]{r}[]{} & 0
                    \end{tikzcd}
                \end{center}

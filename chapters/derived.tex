    ...
    \section{Twisting Morphisms}
        ...
        \subsection{Twisted Tensor Products}
            ...
            \begin{proof}
                ...
                Consider the graded differential component $\tt{gr}_pd^l_{\iota_C}$ when it acts as a morphism $\tt{gr}_{i_1}C \otimes \tt{gr}_{i_2}\Omega C \rightarrow \tt{gr}_{i_1+i_2}\Omega C$. This can be considered as an isomorphism 
                \begin{align*}
    ...
    \section{Polydules}
        ...
        \subsection{The Derived Category $D_\infty A$ of Augmented $A_\infty$ Algebras} 
            ...
            \begin{proof}
                ...
                \begin{center}
                    \begin{tikzcd}
                        \tt{Mod}^{UA} \ar[]{d}[]{R_{\iota_{BA}}} \ar[]{r}[]{i} & \tt{suMod}_{\infty, strict}^A \ar[]{d}[]{\iota} \\
                        \tt{coMod}^{BA} & \tt{suMod}_\infty^A \ar[]{l}[]{B}
                    \end{tikzcd}
                \end{center}

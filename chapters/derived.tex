...
\begin{document}
    ...
    \section{Polydules}
        ...
        \subsection{Polydules of SHA-algebras}
            ...
            \begin{definition}
                Suppose there are two $\infty$-morphisms $f,g : M \rightsquigarrow N$ between two $A$-polydules, then $f$ is homotopic to $g$, written as $f \sim g$, if there is a homotopy $h : M \rightsquigarrow N$ as above.s
            \end{definition}

...
\begin{document}
    ...
    \section{Polydules}
        ...
        \subsection{Homological unitary SHA-Algebras and -Polydules}

            Skriv noe bullshit her
    ...
    \section{The Derived Category $D_\infty A$}
        ...
        \subsection{The Derived Category of Strictly Unital SHA-Algebras}
            ...
            - Tria A -tar mye tid, trenger homologisk unitære ting
            - HA - Kort tid
            - ModA[Qis] - Litt stress?
            - DUA - Trenger operadisk universal enveloping algebra...
\end{document}
    ...
    \section{Twisting Morphisms}
        ...
        \subsection{Twisted Tensor Products}
            ...
            \begin{proof}
                ...
                \begin{center}
                    \begin{tikzcd}
                        ... \ar[]{r}[]{d^r_{\pi_A}} & M\otimes BA_{(i)}\otimes A \ar[]{r}[]{d^r_{\pi_A}} \ar[loop, distance = 2em]{}[above]{d_{M\otimes BA_{(i)}\otimes A}} & ... \ar[]{r}[]{d^r_{\pi_A}} & M\otimes BA_{(1)}\otimes A \ar[]{r}[]{d^r_{\pi_A}} \ar[loop, distance=2em]{}[above]{d_{M\otimes BA_{(1)}\otimes A}} & M \otimes A \ar[]{r}[]{0} \ar[loop, distance=2em]{}[above]{d_{M\otimes A}} & 0
                    \end{tikzcd}
                \end{center}
                ...
                \begin{center}
                    \begin{tikzcd}
                        ... \ar[]{r}[]{d^r_{\pi_A}} & M\otimes BA_{(i)}\otimes A \ar[]{r}[]{d^r_{\pi_A}} \ar[loop, distance = 2em]{}[above]{d_{M\otimes BA_{(i)}\otimes A}} & ... \ar[]{r}[]{d^r_{\pi_A}} & M\otimes BA_{(1)}\otimes A \ar[]{r}[]{d^r_{\pi_A}} \ar[loop, distance=2em]{}[above]{d_{M\otimes BA_{(1)}\otimes A}} & M \otimes A \ar[]{r}[]{\varepsilon_M} \ar[loop, distance=2em]{}[above]{d_{M\otimes A}} & M \ar[loop, distance = 2em]{}[above]{d_M} \ar[]{r}[]{0} & 0
                    \end{tikzcd}
                \end{center}
        ...
        \subsection{Model Structure on Module Categories}
            ...
            \begin{itemize}
                ...
                \item[Fibrations] $f : M\rightarrow N$ is a fibration if $f^\#$ is an epimorphism.
                \item[Cofibrations] $f : M\rightarrow N$ is a cofibration if it has LLP to acyclic fibrations. 
            \end{itemize}
        ...
        \subsection{Model Structure on Comodule Categories}
            ...
            \begin{itemize}
                ...
                \item[Cofibrations] $f : M \rightarrow N$ is a cofibration if $f^\#$ is a monomorphism.
                \item[Fibrations] $f : M \rightarrow N$ is a fibration if it har RLP to acyclic cofibrations.
            \end{itemize}

    ...
    \section{Twisting Morphisms}
        ...
        \subsection{Triangulation of Homotopy Categories}
            ...
            \begin{lemma}\label{lem: homo-proj-homo-well-def}
                If $P$ is the colimit of a filtration admitting (F2) and (F3'), then $P$ are homotopically projective.
            \end{lemma}
            ...
            The final ingredient to construct a homotopically projective resolution for our complexes is the acyclic assembly lemma \cite{Weibel94}.
            ...
            \begin{proof}
                ...
                We want to construct $\mathcal{E}$-projectives be on the form of homotopically projective complexes. $A[-n]$ is $\mathcal{E}$-projective by the following isomorphism.
                \begin{align*}

...
\begin{document}
    ...
    \section{Coalgebras}
            ...
            The category of left $C$-comodules is denoted as $CoMod_C$, where the morphisms $Hom_C(\_,\_)$ are $C$-colinear. Likewise, the category of right $C$-comodules is denoted as $CoMod^C$.

...
>>>>>>> 8ca8e935ed0e2025211e253ac7ddb3e4a0d0b4af
            ...
            \begin{center}
                \begin{tikzcd}
                    ...
                    ... \ar[]{r}[below]{d_A^\bullet} & A^{-1} \ar[]{r}[below]{d_A^\bullet} \ar[]{u}[]{\varepsilon_A} & A^0 \ar[]{r}[below]{d_A^\bullet} \ar[]{u}[]{\varepsilon_A} & A^{1} \ar[]{r}[below]{d_A^\bullet} \ar[]{u}[]{\varepsilon_A} & ... \\
                    ... \ar[]{r}[below]{d_{A^{\otimes 2}}^\bullet} & (A^{\otimes 2})^{-1} \ar[]{r}[below]{d_{A^{\otimes 2}}^\bullet} \ar[xshift = -0.5ex]{u}[left]{\nabla_A} \ar[xshift = 0.5ex]{u}[right]{A\otimes\varepsilon_A} & (A^{\otimes 2})^0 \ar[]{r}[below]{d_{A^{\otimes 2}}^\bullet} \ar[xshift = -0.5ex]{u}[left]{\nabla_A} \ar[xshift = 0.5ex]{u}[right]{A\otimes\varepsilon_A} & (A^{\otimes 2})^{1} \ar[]{r}[below]{d_{A^{\otimes 2}}^\bullet} \ar[xshift = -0.5ex]{u}[left]{\nabla_A} \ar[xshift = 0.5ex]{u}[right]{A\otimes\varepsilon_A} & ... \\

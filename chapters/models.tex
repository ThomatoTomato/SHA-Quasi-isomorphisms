...
\begin{document}
    ...
    \begin{proposition}[{\cite[Proposition 1.3.4.1][49]{LefevreHasegawa03}}]\label{prop: homotopy-is-homotopy}
        ...
        \begin{itemize}
            \item If $f\sim g$ by an $(f,g)$-coderivation $h$, then they are left homotopic.
            \item If $D$ is fibrant, then $f\sim g$ by an $(f,g)$-coderivation if and only if $f$ and $g$ are left homotopic.
        \end{itemize}
    \end{proposition}

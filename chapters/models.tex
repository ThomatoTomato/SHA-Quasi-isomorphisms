...
\begin{document}
    ...
    \subsection{Homotopy theory of $A_{\infty}$-algebras}
        ...
        \begin{proof}
            ...
            The cofibrations of $\tt{coAlg}_{\mathbb{K},conil}^\bullet$ are monomorphisms. Since $B$ is an equivalence of categories it necesserilly have to preserve and reflect monomorphisms. \todo{Er virkelig monomorfier av A-uendelig-algebraer morfier hvor $f_1$ er mono?}

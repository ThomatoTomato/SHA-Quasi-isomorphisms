...
\begin{document}    
    ...
    \section{Model categories}
        ...
        \subsection{Homotopy category}
            ...
            Derived functors come into play whenever this is not the case. These lifts are however the closest approximation which we can make functorial. The general exposition of derived functors is beyond the scope of this thesis, but a general account of it may be found in \cite{Riehl16}, \todo{More citations?}. As we will see, model categories are a nice environment to work with these concepts. Firstly we will amend the problem with localizations, where the homotopy category may not exists. Secondly, we will obtain a simple description of some important derived functors.
        ...
        \subsection{Quillen adjoints}
            ...
            \begin{proof}
                We will not give a proof here. A proof may be found in Reihl \cite{Riehl16} under proposition 6.4.11.
            \end{proof}
    ...
    \section{Homotopy theory of $A_{\infty}$-algebras}
        ...
        \begin{proof}
            ...
            \begin{center}
                \begin{tikzcd}
                    C \ar[equal]{r}[]{} \ar[]{d}[]{\eta_C} & C \ar[]{d}[]{0} \\
                    B\Omega C \ar[]{r}[]{0} \ar[dashed]{ru}[]{r} & 0
                \end{tikzcd}
            \end{center}

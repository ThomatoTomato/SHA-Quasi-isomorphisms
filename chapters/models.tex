...
\begin{document}
    ...
    \subsection{Homotopy theory of $A_{\infty}$-algebras}
        ...
        \begin{proof}[proof of \ref{thm: model-A-inf}]
            ...
            \begin{center}
                \begin{tikzcd}
                    C \ar[]{r}[]{p} & Cok j_1 \ar[]{r}[]{c'} & Ker q_1 \ar[]{r}[]{i} & D
                \end{tikzcd}
            \end{center}

...
\begin{document}    
    ...
    \section{A Model structure on DG-Algebras}
            ...
            \begin{example}
                We already know some categories which satsifies these conditions.
                \begin{enumerate}
            ...
            With this adjunction, we may define three classes of morphisms: weak equivalences, fibrations and cofibrations. Let $f\in \mathcal{C}$ be a morphism, then:
            \begin{itemize}
            ...
            \begin{proof}
                ...
                \begin{center}
                    \begin{tikzcd}
                        ...
                        F(cone(\alpha)) \ar[bend right]{rrd}[]{f'} \ar[]{r}[]{e} & A\langle M,\alpha\rangle \ar[dashed]{rd}[]{\widtilde{f}} \\
                        & & B
                    \end{tikzcd}
                \end{center}
te
                To obtain naturality, we observe that the element $(a, e^Ti)$ is in fact universal.
            \end{proof}

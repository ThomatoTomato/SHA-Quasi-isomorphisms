...
% --- Folder structure --- %
    \usepackage{subfiles} 
    % Allows compilation of each subfile rather than compiling everything at once
    % Subfiles must have this file as an option while using the document class subfile
...
\begin{document}
    ...
    % --- Appendix D --- %
    \chapter{Symmetric Monoidal Categories}\label{ch: sym-mon}
